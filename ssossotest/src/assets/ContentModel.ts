...
export const mbtiModel: MBTIContentModel[] = [
  ...
  },
  {
    ...
    question: [
      ...
      '과 공지방에 필참하라는 과대의 톡이 올라왔어',
      'https://i.pinimg.com/564x/07/3f/97/073f970c5b97bd0218c7eea7c5064b2b.jpg',
    ],
    answer: [
      {
        answer: '새로운 친구 많이 사귈 수 있겠다! 벌써부터 신나 ☺️',
        score: 1,
      },
      { answer: '어색한 사람도 많을텐데... 걱정되네 😢', score: 2 },
    ],
    type: 'EI',
    result: -1,
  },
  ...
  },
  {
    ...
    answer: [
      { answer: '뭐 먹지? 이따가 땡기는 거 먹어야겠다~', score: 1 },
      {
  ...
  },
  {
    ...
    answer: [
      ...
      { answer: '친한 동기들 쪽으로 가서 같이 논다.', score: 2 },
    ],
    type: 'EI',
    result: -1,
  },
